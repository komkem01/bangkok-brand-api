...
func New(conf *config.Config[Config], db entitiesinf.ShipmentTrackingHistoryEntity) *Module {
	tracer := otel.Tracer("bangkok-brand.modules.shipmenttrackinghistory")
